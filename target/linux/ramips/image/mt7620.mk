...
define Device/ArcherMR200
  ...
  TPLINK_HWREV := 0x4a
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-net kmod-usb-net-rndis kmod-usb-serial kmod-usb-serial-option adb-enablemodem kmod-mt76x0e
...
define Device/rt-ac51u
  ...
  DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-usb-ehci kmod-usb-ledtrig-usbport kmod-mt76x0e
endef
